"""
TCN Model OOD Inference Script
Load pretrained TCN models and test them on identified OOD weather windows
"""
...
def load_model_and_scaler(model_path, scaler_path, input_channels, horizon, 
                          hidden_channels, levels, kernel_size, dilation_base, dropout):
    """Load pretrained TCN model and scaler"""
    model = TCNModel(
...
def main():
    parser = argparse.ArgumentParser(description='TCN OOD Inference')
    ...
    parser.add_argument('--model_dir', type=str, 
                       default=os.path.join(ROOT_DIR, 'outputs', 'forecast1111', 'per_region', 'tcn_single_train'),
    ...
    parser.add_argument('--levels', type=int, default=4, help='Number of TCN levels')
    ...
    parser.add_argument('--output_dir', type=str,
                       default=os.path.join(ROOT_DIR, 'outputs', 'ood_inference', 'tcn'),
